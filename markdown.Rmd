...
Al ver el cruce entre los valores de Temperatura de Abrigo y la Radiación Global, podríamos llegar a inferir una correlación positiva entre ambas. Por tal motivo, vamos a realizar un modelo de regresión lineal simple para comprobarlo.
