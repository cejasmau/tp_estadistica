...
En relación a la validez del modelo, verificamos que el p-valor de la pendiente es muy pequeño, lo que puede significar que exista una relación lineal entre ambas variables o que con un polinomio de mayor orden se obtenga un mejor resultado. Si bien el p-valor de la ordenada al origen también es chico, el bajo valor del coeficiente de correlación nos hace dudar acerca de la representatividad del modelo. Por ello, vamos a testear los supuestos de independencia y distribución de los que partimos para obtener estos valores:
...
Finalmente, la curva de QQ-Plot nos permite observar que la condición de normalidad ajusta bien, tomando apenas una forma de S en las puntas.
